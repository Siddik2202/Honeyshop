...
if(isset($_GET['delete_all'])){
    $delete_wishlist = $conn->prepare("DELETE FROM `wishlist` WHERE user_id = :user_id ");
...
<div class="box-container">
        ...
        $results = $select_wishlist->fetchAll(PDO::FETCH_ASSOC);
        ...
        <form method="post" class="box">
            ...
            <div class="icon">
                ...
                <a href="wishlist.php?delete=<?php echo $result['id']  ?>"  class="bi bi-x" onclick="return confirm('do you want to delete items in your wishlist')" ></a>
